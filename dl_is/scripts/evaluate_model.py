...
sys.path.insert(0, '.')
from dl_is.isegm.inference import utils
from dl_is.isegm.utils.exp import load_config_file
from dl_is.isegm.utils.vis import draw_probmap, draw_with_blend_and_clicks
from dl_is.isegm.inference.predictors import get_predictor
from dl_is.isegm.inference.evaluation import evaluate_dataset
